---
title:  "[Data_type] 파이썬의 데이터: 타입, 가변성, 참조, 복사"
toc: true
toc_sticky: true
header:
...
![](/assets/images/object.png){: width="50%" }  
...
![](/assets/images/shallow_1.png){: width="70%" }  

#### 깊은 복사  
따라서 이러한 경우에 필요한 것이 바로 깊은 복사입니다.  
![](/assets/images/deepcopy.png){: width="70%" }  
